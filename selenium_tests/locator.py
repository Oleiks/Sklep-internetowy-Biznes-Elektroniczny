...
class MainPageLocators(object):
    SEARCH_BOX = [By.XPATH, "//input[@placeholder='Szukaj w naszym katalogu']"]
    LOGIN_AREA = (By.CLASS_NAME, "user-info")
    GO_TO_CART_BUTTON = (By.XPATH, "//span[normalize-space()='Koszyk']")
...
class CheckoutPageLocators(object):
    PRE_DONE_ADDRESS = (By.CLASS_NAME, "address")
